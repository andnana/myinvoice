        ...
        <div class="container">
        	...
        	<section class="content">
                <article>
                	...
                	<div>
                	<s:if test="news.imgname != null">
                	<a href="javascript:void(0)"><img src="<%=basePath %>pic_news/<s:property value="news.imgname"/>" alt=""></a>
                	</s:if>
                	<s:else>
                	<a href="javascript:void(0)"><img src="<%=basePath %>pic_news/default.jpg" alt=""></a>
                	</s:else>
                    </div>
                  ...
                  <h3><s:property value="news.title"/></h3>
                    <ul>
                      ...
                      <!--   <li class="category">分类: <a href="#"><s:property value="news.sortname"/></a></li> -->
                        ...
                        <li class="comment"><a href="comment.action?newsid=<s:property value='news.id'/>&page=<s:property value="page"/>&parentid=0">点击评论</a>
                    </ul>
             ...
             <ul class="pagination">
            	  ...
            	  <s:if test="page gt 1"><li><a href="newsdetail.action?page=<s:property value="page-1"/>&newsid=<s:property value="newsid"/>">&laquo;</a></li></s:if>
                  
                  
                  
                  <s:iterator var="p" begin="1" end="totalPage">
                  <li><a href="newsdetail.action?page=<s:property value="#p"/>&newsid=<s:property value="newsid"/>" <s:if test="page eq #p">class="active"</s:if>><s:property value="#p"/></a> </li>
                  </s:iterator>
                  <s:if test="page lt totalPage"><li><a href="newsdetail.action?page=<s:property value="page+1"/>&newsid=<s:property value="newsid"/>">&raquo;</a></li></s:if>
            	</ul>
