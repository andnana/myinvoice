...
<%@taglib uri="http://java.sun.com/jstl/core_rt" prefix="c" %>
        ...
        <div class="row-fluid">
			<div class="page-header">
				<h1>顾客信息列表&nbsp;&nbsp;<small><a href="toaddcustomer.action">添加顾客信息</a></small></h1>
			</div>
 ...
 <s:else>  
      <s:property value="address" />  
        ...
        <td><a href="deletecustomer.action?customerid=<s:property value="id"/>">删除</a>&nbsp;|&nbsp;<a href="tocustomerdetail.action?customerid=<s:property value="id"/>">详细</a></td>
        </tr>    	
